...
' // ============================================
' // Copyright 2002 Paul Mather and Andy Matteson
' // ============================================

' // MODULE HEADER
' // ¯¯¯¯¯¯¯¯¯¯¯¯¯
' // Description  : MsgBoxEx function, optimized MsgBox.  Made from scratch.
' // Usage        : Just add this module to your project.  Then, type this code to use it:
' // Usage        : Call MsgBoxEx(Prompt, [Buttons], [Title], [HelpFile], [Context], [CenterForm], [hWnd], [button1Text], [button2Text], [button3Text])
' //              :
' // Returns      : VbMsgBoxResult (vbAbort, vbCancel, vbIgnore, vbNo, vbOK, vbRetry, vbYes
' //              :
' // Purpose      : Demonstrates the use of Message Box Hooks.
' // This code    : Allows you to change message box caption buttons, and enables you to center the form.
' //              :
' // Known Bugs   : If you specify vbMsgBoxHelpButton in the Buttons parameter, the caption won't change for the help button.  We are currently working on it.
' // Side Effects : None Known
' //              :
' // As seen on   : www.planet-source-code.com

' // --------------------------
' // Begin module modMessageBox
